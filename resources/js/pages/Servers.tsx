        ...
        <AppLayout breadcrumbs={[{ title: 'Servers', href: '/servers' }]}>
            ...
            <div className="min-h-screen bg-black p-6 font-[Orbitron] text-white">
                ...
                <div className="border-cyan mb-6 flex items-center justify-between">
                    <h1 className="text-3xl font-semibold tracking-widest text-cyan-400 drop-shadow-[0_0_5px_#0ff]">SERVERS</h1>
                    <button
                ...
                <div className="space-y-6 rounded-xl border border-cyan-700 bg-[#0a0a0a] p-6">
                    {/* Search + GroupBy */}
                    <form onSubmit={handleSearch} className="mb-6 flex flex-wrap items-center justify-between gap-4">
                        {/* Agrupación + Orden */}
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="rounded-md border border-cyan-700 bg-black px-4 py-2 text-sm text-cyan-200 shadow-[0_0_5px_#0ff] focus:outline-none"
                            >
                        ...
                        <div className="relative w-full max-w-sm">
                            <input
                                ...
                                className="w-full rounded-md border border-cyan-700 bg-black px-4 py-2 pl-10 text-sm text-cyan-200 shadow-[0_0_5px_#0ff] placeholder:text-cyan-600 focus:outline-none"
                            />
                    ...
                    <div className="overflow-hidden rounded-lg border border-cyan-700 bg-neutral-950 shadow-[0_0_10px_#0ff3]">
                        <div className="w-full overflow-x-auto">
                            <table className="min-w-full table-auto text-sm">
                                <thead className="bg-cyan-900/10 text-cyan-400">
                                    <tr>
